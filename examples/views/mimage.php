...
m_image('i-dont-exists.jpg');", "Fallback 3", "Non existing image with fallback existing image without description over"),
		array("m_image_cache_dir('../cache');
m_image('$file', 200, 150, 1);", "Resize with cache", "Resize image, saves to a cache and flush. If cache file exists passthru the cache"),
...
m_image_mix('$file',
		...
		"Image mixing with cache", "Mixing 3 images using cache"),
		...
		array("m_image_cache_dir('../cache');
m_image_string(m_image('$file',200,200,1,'mimage'), 'Great text here');", "Image text with cache", "Similar using cache"),
